    ...
    return (
        ...
        <div className="wrapper2" style={{ 'paddingTop': '64px' }}>
            ...
            <div className={style.allProjects}>
                ...
                <ShowProject id='2' title='Imagym' description='Imagym initialy developed in Wordpress by someone else. I decided to re-make it in JQuery for optimization purposes' image={imagym} image2={imagym} gitHub={'https://github.com/DionysisP/gym_website'} />
