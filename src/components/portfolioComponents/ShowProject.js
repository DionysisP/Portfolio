...
export default function ShowProject(props) {
    return (
        <div className={style.singleProject}>
            ...
            <a href="https://github.com/DionysisP" target="_blank" rel="noreferrer"><button style={{ 'backgroundColor' : '#F81783'}}className={style.btn}>
                View Code
                <svg className={style.icon} xmlns="http://www.w3.org/2000/svg" fill="white" width="30" height="30" viewBox="0 0 24 24">
