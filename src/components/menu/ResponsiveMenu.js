...
export default function ResponsiveMenu()
{
    ...
    return (
        <div className={classes.topBarBackground}>
            ...
            <svg onClick={() => setShowMenu(!showMenu)} className={classes.burger} width="34" height="23" viewBox="0 0 46 46" fill="white" xmlns="http://www.w3.org/2000/svg">
            <path d="M5.75 34.5H40.25V30.6667H5.75V34.5ZM5.75 24.9167H40.25V21.0833H5.75V24.9167ZM5.75 11.5V15.3333H40.25V11.5H5.75Z" fill="white"/>
            </svg>
