    ...
    <div className="App">
      ...
      <Switch>
        ...
        <Route path={'/project/1'} exact>
          <Project title='Mykonos Instant Transfer' desc="A Single page application I designed and developed in a couple of hours.I used a Wordpress-like theme and rushed it using public domain images " url={'http://mykonos-instant-transfer.com/'} technologies={'HTML, CSS, JQuery'} git={'https://github.com/DionysisP/mykonosProject'} img={mykonos} color1='56ADFD' color2='20C276' color3='FFFFFF' color4='5A5A5A' />
        </Route>
